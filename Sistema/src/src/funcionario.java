package src;
	...
	public class funcionario {
			...
			// Adicionar o funcionário criado à lista
			...
			//Método para exibir informações sobre os funcionários
			...
			// Método para buscar funcionário pelo identificador
